<div class="flex-1 relative" x-data>
    ...
    <form action="{{ route('search') }}" autocomplete="off">
        <x-jet-input name="name" wire:model="search" type="text" class="w-full text-white focus:text-gray-900 bg-gray-400 focus:bg-white font-bold "
        ...
        <div class="bg-white rounded-lg shadow-lg mt-1">
            <div class="px-4 py-3 space-y-1">
                ...
                @empty
                    ...
                    <p class="text-lg leading-5"> No existe ningun registro</p>
