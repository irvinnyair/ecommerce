    ...
    <div class="col-span-3">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="mb-4">
                ...
                <x-jet-input    type="text" 
                                ...
                                placeholder="Ingrese el nombre de la persona que recibiera el producto"
                                class="w-full" />
            ...
            <div>
                ...
                <x-jet-input    type="text" 
                                ...
                                placeholder="Ingrese el número de contácto"
                                class="w-full" />
        ...
        <div class="" x-data="{ envio_type: @entangle('envio_type') }">
            ...
            <label class="bg-white rounded-lg shadow-lg px-6 py-4 flex items-center mb-4 cursor-pointer">
                ...
                <span class="ml-2 text-gray-700">Recojo en tienda (Direcion falsa)</span>
        ...
        <div>
            ...
            <p class="text-sm text-gray-700 mt-2">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sequi laboriosam illo optio quibusdam iusto beatae aut, quam quaerat rem dignissimos perferendis enim saepe officiis accusamus excepturi consequatur velit ratione recusandae! <a href="" class="font-semibold text-orange-500">Politica y privacidad</a></p>
        </div>
    </div>
    <div class="col-span-2 ">
        <div class="bg-white rounded-lg shadow-lg p-6">
