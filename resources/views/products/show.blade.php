    ...
    <div class="container py-8">
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="flex">
                    <p class="text-trueGray-700">Marca: <a class="underline capitalize hover:text-blue-600" href="">{{ $product->brand->name }}</a></p>
                    <p class="text-trueGray-700 mx-6">5 <i class="fas fa-star text-sm text-yellow-400"></i></p>
                    <a href="" class="text-blue-600 hover:text-blue-800 underline">39 reseñas</a>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg mb-6">
                    <div class="p-4 flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-lg font-semibold text-greenLime-600"> Envíos a todo el país </p>
